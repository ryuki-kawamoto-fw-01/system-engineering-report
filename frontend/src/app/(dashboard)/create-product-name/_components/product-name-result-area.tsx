...
export default function ProductNameResultArea() {
  const dispatch = useAppDispatch();
  //  const { result, id, feedbackAt } = useAppSelector((state) => state.createProductName);
  ...
  function downloadMessage() {
    ...
    element.download = `製品名ネーミング案_${timestamp}.txt`;
    ...
    <>
      ...
      <div className="relative h-full">
        ...
        <Textarea
          ...
          placeholder="ここに生成されたネーミング案が表示されます"
          readOnly={!isEditing}
          className="h-full"
        />
      </div>
