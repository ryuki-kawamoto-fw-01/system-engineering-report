...
import { setReset } from '@/app/_store/slice/corporate-survey';
import { getMessage } from '@/app/_utils/message';

export default function CorporateSurveyTitle(): JSX.Element {
  ...
  return (
    <div className="flex items-center">
      <Heading level={3} className="mr-1.5 flex items-center gap-x-[2px]">
        企業調査
        <Help message="企業名を入力するだけで、企業概要や売上といった企業情報を検索できる画面です。" />
      </Heading>
      <TooltipProvider>
        <Tooltip>
