...
import { setFeedbackAt } from '@/app/_store/slice/quality-standard-document';
...
export default function ActionButtons({
  ...
  const { result, id, feedbackAt } = useAppSelector((state) => state.qualityStandardDocument);
  ...
  function downloadMessage() {
    ...
    element.download = `品質標準文書_${timestamp}.txt`;
    ...
    <>
      {!isEditing ? (
        <div className="flex items-center">
          <FeedbackGoodButton
            source="qualityStandardDocument"
            messageId={id}
