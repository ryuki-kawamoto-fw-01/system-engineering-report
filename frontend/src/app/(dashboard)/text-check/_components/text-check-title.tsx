...
import { setReset } from '../../../_store/slice/text-check';

export default function TextCheckTitle(): JSX.Element {
  ...
  return (
    <div className="flex items-center">
      ...
      <Help message="指定した条件の内容を満たしているかチェックする画面です。" className="mr-1.5" />
      <TooltipProvider>
        <Tooltip>
