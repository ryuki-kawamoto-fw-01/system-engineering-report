...
import { setNewRequest } from '@/app/_store/slice/marketingstrategy';

import { Textarea } from '../../../_components/ui/textarea';

import { NewMarketingStrategySchema } from '../_utils/schema';
...
export default function RequestForm({ className }: Props) {
  ...
  } = useFormReduxContext<NewMarketingStrategySchema>({
        ...
        render={({ field }) => (
          <FormItem className="flex h-full flex-col">
            ...
            <Textarea
              ...
              placeholder="例：指定したセグメントについて、四半期単位での戦略を作成する。"
