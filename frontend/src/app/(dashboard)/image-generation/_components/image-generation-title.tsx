...
import { setReset } from '../../../_store/slice/image-generation';

export default function ImageGenerationTitle(): JSX.Element {
  ...
  return (
    <div className="flex items-center">
      ...
      <Help message="入力した内容に基づいて画像を生成する画面です。" className="mr-1.5" />
      <TooltipProvider>
        <Tooltip>
