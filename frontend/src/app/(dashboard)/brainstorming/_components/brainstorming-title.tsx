...
import { setReset, setResult } from '../../../_store/slice/brainstorming';

export default function BrainstormingTitle(): JSX.Element {
  ...
  return (
    <div className="flex items-center">
      ...
      <Help
        message="指定した専門家ごとに順番にアイデアを出し、テーマに対する多角的な発想を促進する画面です。"
        className="mr-1.5"
      />
      <TooltipProvider>
        <Tooltip>
