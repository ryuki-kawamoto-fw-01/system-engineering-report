...
import { setResult, setFeedbackAt } from '@/app/_store/slice/create-technology-proposal';
...
export default function TechnologyProposalResultArea({ className }: Props) {
  const dispatch = useAppDispatch();
  const { result, id, feedbackAt } = useAppSelector((state) => state.createTechnologyProposal);
  ...
  function downloadMessage() {
    ...
    element.download = `新技術導入提案書_${timestamp}.txt`;
    ...
    <div className={className}>
      ...
      <div className="relative h-full">
        ...
        <Textarea
          ...
          placeholder="ここに生成された新技術導入提案書が表示されます"
          readOnly={!isEditing}
          className="h-full"
        />
      </div>
