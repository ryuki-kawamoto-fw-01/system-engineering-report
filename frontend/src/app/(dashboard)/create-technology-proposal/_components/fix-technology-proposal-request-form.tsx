...
import { setModify } from '@/app/_store/slice/create-technology-proposal';

import { Textarea } from '../../../_components/ui/textarea';

import { FixTechnologyProposalSchema } from '../_utils/schema';

type Props = {
  className?: string;
};

export default function FixTechnologyProposalRequestForm({ className }: Props) {
  const {
    control,
    onChangeField,
    formState: { isSubmitting, isValid },
  } = useFormReduxContext<FixTechnologyProposalSchema>({
    setRedux: setModify,
  });
