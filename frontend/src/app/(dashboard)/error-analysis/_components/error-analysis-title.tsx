...
import { setReset } from '../../../_store/slice/error-analysis';

export default function ErrorAnalysisTitle(): JSX.Element {
  ...
  return (
    <div className="flex items-center">
      ...
      <Help message="プログラミングエラーの解説と解決策を提示する画面です。" className="mr-1.5" />
      <TooltipProvider>
        <Tooltip>
