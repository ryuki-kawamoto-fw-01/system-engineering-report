...
import { setResult } from '../../../_store/slice/product-service-benefit-idea';
...
import IdeationResultArea from './result-area';
...
export default function IdeationResults({ className }: Props) {
  const { newIdeaRequest, result, id, feedbackAt } = useAppSelector(
