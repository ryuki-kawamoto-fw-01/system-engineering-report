...
import { setReset } from '../../../_store/slice/product-catchphrase';

export default function ProductCatchphraseTitle(): JSX.Element {
  ...
  return (
    <div className="flex items-center">
      ...
      <Help
        message="入力した情報を元に、印象的かつ効果的なキャッチコピーを生成する画面です。"
        className="mr-1.5"
      />
      <TooltipProvider>
        <Tooltip>
