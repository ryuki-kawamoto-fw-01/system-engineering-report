...
import { setResult, setFeedbackAt } from '@/app/_store/slice/create-design-document';
...
export default function ResultArea({ className }: Props) {
  ...
  const { result, id, feedbackAt } = useAppSelector((state) => state.designDocument);
  ...
  function downloadMessage() {
    ...
    element.download = `設計書_${timestamp}.txt`;
    ...
    <div className={className}>
      ...
      <div className="relative h-full">
        ...
        <Textarea
          ...
          placeholder="ここに生成された設計書が表示されます"
          readOnly={!isEditing}
          className="h-full"
        />
      </div>
