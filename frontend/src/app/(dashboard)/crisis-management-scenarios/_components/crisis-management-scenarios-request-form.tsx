...
import { setNewRequest } from '@/app/_store/slice/crisis-management-scenarios';

import { Textarea } from '../../../_components/ui/textarea';

import { NewCrisisManagementScenariosSchema } from '../_utils/schema';
...
export default function RequestForm({ className }: Props) {
  ...
  } = useFormReduxContext<NewCrisisManagementScenariosSchema>({
    setRedux: setNewRequest,
  });
        ...
        render={({ field }) => (
          <FormItem className="flex h-full flex-col">
            ...
            <Textarea
              ...
              placeholder="例：現場責任者、現場リーダー、現場作業員毎に危機シナリオと予防策を生成する"
