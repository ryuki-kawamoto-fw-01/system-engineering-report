...
import { setResult, setFeedbackAt } from '@/app/_store/slice/crisis-management-scenarios';
...
export default function ResultArea({ className }: Props) {
  ...
  const { result, id, feedbackAt } = useAppSelector((state) => state.crisisManagementScenarios);
  ...
  function downloadMessage() {
    ...
    element.download = `危機管理シナリオ_${timestamp}.txt`;
    ...
    <div className={className}>
      <div className="mb-1 flex min-h-8 items-end justify-between">
        ...
        {!isEditing ? (
          <div className="flex items-center">
            <FeedbackGoodButton
              source="crisisManagementScenarios"
              messageId={id}
      ...
      <div className="relative h-full">
        ...
        <Textarea
          ...
          placeholder="ここに生成された危機管理シナリオが表示されます"
          readOnly={!isEditing}
          className="h-full"
        />
      </div>
