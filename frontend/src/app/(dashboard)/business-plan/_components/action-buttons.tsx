...
import { setFeedbackAt } from '@/app/_store/slice/business-plan';
...
export default function ActionButtons({
  ...
  const { answer, id, feedbackAt } = useAppSelector((state) => state.businessPlan);
  ...
  function downloadMessage() {
    ...
    element.download = `事業計画書の作成_${timestamp}.txt`;
