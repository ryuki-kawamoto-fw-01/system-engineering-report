...
import { setResult, setFeedbackAt } from '@/app/_store/slice/create-idea';
...
export default function IdeationResultArea({ className }: Props) {
  ...
  const { result, id, feedbackAt } = useAppSelector((state) => state.createIdea);
  ...
  function downloadMessage() {
    ...
    element.download = `アイディア出し_${timestamp}.txt`;
    ...
    <div className={className}>
      ...
      <div className="relative h-full">
        ...
        <Textarea
          ...
          placeholder="ここに生成されたアイデアが表示されます"
          readOnly={!isEditing}
          className="h-full"
        />
      </div>
