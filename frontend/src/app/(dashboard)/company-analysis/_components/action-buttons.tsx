...
import { setFeedbackAt } from '@/app/_store/slice/company-analysis';
...
export default function ActionButtons({
  ...
  const { result, id, feedbackAt } = useAppSelector((state) => state.companyAnalysis);
  ...
  function downloadMessage() {
    ...
    element.download = `企業分析_${timestamp}.txt`;
  ...
  return (
    <>
      {!isEditing ? (
        <div className="grw flex items-center">
          <FeedbackGoodButton
