...
import { setReset } from '../../../_store/slice/technology-training';

export default function TechnologyTrainingTitle(): JSX.Element {
  ...
  return (
    <div className="flex items-center">
      ...
      <Help message="指定した技術に対してトレーニング計画を作成する画面です。" className="mr-1.5" />
      <TooltipProvider>
        <Tooltip>
