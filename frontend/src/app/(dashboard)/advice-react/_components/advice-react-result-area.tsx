...
import { setResult, setFeedbackAt } from '@/app/_store/slice/advice-react';
...
export default function AdviceReactResultArea({ className }: Props) {
  const dispatch = useAppDispatch();
  const { result, id, feedbackAt } = useAppSelector((state) => state.adviceReact);
  ...
  function downloadMessage() {
    ...
    element.download = `アドバイス(ReAct)_${timestamp}.txt`;
