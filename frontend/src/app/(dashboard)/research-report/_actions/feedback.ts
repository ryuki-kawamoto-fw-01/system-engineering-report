...
export default async function feedbackResearchReport(
  id: string,
  feedbackType: 0 | 1,
  ...
  try {
    ...
    const { resource } = await researchReportContainer
      .item(id, user.id)
      .read<ResearchReportModel>();
    ...
    await researchReportContainer.items.upsert({
      ...resource,
      feedbackType: ftype,
