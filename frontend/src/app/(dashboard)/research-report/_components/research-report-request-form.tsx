...
import { setNewRequest } from '@/app/_store/slice/research-report';

import { Textarea } from '../../../_components/ui/textarea';

import { ResearchNewReportSchema } from '../_utils/schema';
...
export default function RequestForm({ className }: Props) {
  ...
  } = useFormReduxContext<ResearchNewReportSchema>({
