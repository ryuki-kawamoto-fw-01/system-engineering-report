...
import { setResult, setFeedbackAt } from '@/app/_store/slice/research-report';
...
export default function ResultArea({ className }: Props) {
  ...
  const { result, id, feedbackAt } = useAppSelector((state) => state.researchReport);
  ...
  function downloadMessage() {
    ...
    element.download = `研究報告書_${timestamp}.txt`;
      ...
      <div className="relative h-full">
        ...
        {!isEditing ? (
          ...
          <Textarea
            ...
            placeholder="ここに生成された研究報告書が表示されます"
            readOnly={!isEditing}
            className="h-full"
          />
        )}
