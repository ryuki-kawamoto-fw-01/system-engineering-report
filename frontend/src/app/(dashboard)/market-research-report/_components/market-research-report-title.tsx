...
import { setReset } from '../../../_store/slice/market-research-report';

export default function MarketResearchReportTitle(): JSX.Element {
  ...
  return (
    <div className="flex items-center">
      ...
      <Help message="市場調査を行いレポートを作成する画面です。" className="mr-1.5" />
      <TooltipProvider>
        <Tooltip>
