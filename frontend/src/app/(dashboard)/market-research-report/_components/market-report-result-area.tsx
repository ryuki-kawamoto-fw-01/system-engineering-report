...
import { setResult, setFeedbackAt } from '@/app/_store/slice/market-research-report';
...
export default function MarketReportResultArea() {
  const dispatch = useAppDispatch();
  const { result, id, feedbackAt } = useAppSelector((state) => state.marketresearchReport);
  ...
  function downloadMessage() {
    ...
    element.download = `市場調査レポート_${timestamp}.txt`;
  ...
  return (
    <div className="h-full">
      ...
      <div className="relative h-full">
        ...
        {!isEditing ? (
          <Card className="h-full max-h-[600px] overflow-auto">
          ...
          <Textarea
            ...
            placeholder="ここに生成されたレポートが表示されます"
            readOnly={!isEditing}
