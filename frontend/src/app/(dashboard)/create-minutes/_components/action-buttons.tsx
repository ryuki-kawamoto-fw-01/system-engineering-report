...
import { setFeedbackAt } from '@/app/_store/slice/create-minutes';
...
export default function ActionButtons({
  ...
  const { result, feedbackAt, id } = useAppSelector((state) => state.createMinutes);
  ...
  function downloadMessage() {
    ...
    element.download = `議事録_${timestamp}.txt`;
        ...
        <div className="flex items-center">
          ...
          <TooltipProvider>
            <DropdownMenu>
              ...
              <DropdownMenuContent>
                <DropdownMenuItem onClick={downloadMessage} className="cursor-pointer">
                  <SvgDownload className="mr-2 size-4" />
                  ダウンロード
                </DropdownMenuItem>
                <DropdownMenuItem onClick={handleFormatDownload} className="cursor-pointer">
                  <SvgDownload className="mr-2 size-4" />
                  フォーマット出力
                </DropdownMenuItem>
              </DropdownMenuContent>
