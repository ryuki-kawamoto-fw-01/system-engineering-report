...
import { setResult, setFeedbackAt } from '@/app/_store/slice/defect-analysis-report';
...
export default function AnalysisResultArea({ className }: Props) {
  const dispatch = useAppDispatch();
  const { result, id, feedbackAt } = useAppSelector((state) => state.defectAnalysisReport);
  ...
  function downloadMessage() {
    ...
    element.download = `不具合分析レポート_${timestamp}.txt`;
    ...
    <div className={className}>
      ...
      <div className="relative h-full">
        ...
        <Textarea
          ...
          placeholder="ここに生成された不具合分析レポートが表示されます"
          readOnly={!isEditing}
          className="h-full"
        />
      </div>
