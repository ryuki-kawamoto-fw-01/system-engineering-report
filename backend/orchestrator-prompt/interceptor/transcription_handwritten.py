...
class TranscriptionHandwrittenInterceptor(ErrorHandler):
    @classmethod
...
def transcription_handwritten_error_handler(
    ...
    def wrapper(req: azure_func.HttpRequest) -> azure_func.HttpResponse:
        try:
            ...
            error_response, status_code = TranscriptionHandwrittenInterceptor.handle_error(e, req)
