...
class TroubleShootingGuideInterceptor(ErrorHandler):
    @classmethod
...
def trouble_shooting_guide_error_handler(
    ...
    def wrapper(req: azure_func.HttpRequest) -> azure_func.HttpResponse:
        try:
            ...
            error_response, status_code = TroubleShootingGuideInterceptor.handle_error(
                e, req
            )
