...
class KeyPointExtractionInterceptor(ErrorHandler):
    @classmethod
...
def key_point_extraction_error_handler(
    ...
    def wrapper(req: azure_func.HttpRequest) -> azure_func.HttpResponse:
        try:
            ...
            error_response, status_code = KeyPointExtractionInterceptor.handle_error(
                e, req
            )
