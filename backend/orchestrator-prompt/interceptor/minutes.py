...
class MinutesInterceptor(ErrorHandler):
    @classmethod
...
def minutes_error_handler(
    ...
    def minutes_wrapper(req: azure_func.HttpRequest) -> azure_func.HttpResponse:
        try:
            return func(req)
        except Exception as e:  # noqa: BLE001
            error_response, status_code = MinutesInterceptor.handle_error(e, req)
    ...
    minutes_wrapper.__name__ = func.__name__  # デプロイ時の関数名を維持
    return minutes_wrapper
