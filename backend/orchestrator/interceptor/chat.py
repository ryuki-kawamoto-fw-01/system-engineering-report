...
class ChatInterceptor(ErrorHandler):
    @classmethod
...
def chat_error_handler(
    ...
    def wrapper(req: azure_func.HttpRequest) -> azure_func.HttpResponse:
        logging.info(f"chat_error_handler:{req}")
        try:
            return func(req)
        except Exception as e:  # noqa: BLE001
            error_response, status_code = ChatInterceptor.handle_error(e, req)
