...
EXC_TO_TABLE: dict[Type[Exception], tuple[str, ErrorCode]] = {
    ...
    UnprocessableEntityError: ("E_B4_00020", ErrorCode.INTERNAL_ERROR),
    FileNotFoundError: ("E_B4_00030", ErrorCode.NOT_FOUND),
    ValueError: ("E_B4_00020", ErrorCode.BAD_REQUEST),
    KeyError: ("E_B4_00010", ErrorCode.BAD_REQUEST),
...
def azure_function_download_error_handler(
    func: Callable[[azure_func.HttpRequest], azure_func.HttpResponse],
