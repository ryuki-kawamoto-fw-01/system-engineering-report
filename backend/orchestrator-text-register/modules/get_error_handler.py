...
from openai import InternalServerError, UnprocessableEntityError
...
EXC_TO_TABLE: dict[Type[Exception], tuple[str, ErrorCode]] = {
    InternalServerError: ("E_B4_00060", ErrorCode.INTERNAL_ERROR),
    NotFoundError: ("E_B4_00050", ErrorCode.NOT_FOUND, {"value": "フォルダ"}),
    FileNotFoundError: ("E_B4_00050", ErrorCode.NOT_FOUND, {"value": "ファイル"}),
    PermissionDeniedError: (
        "E_B4_00020",
        ErrorCode.FORBIDDEN,
    ),
    ...
    ValueError: ("E_B4_00040", ErrorCode.BAD_REQUEST),
    KeyError: ("E_B4_00040", ErrorCode.BAD_REQUEST),
...
class ErrorHandler:
    ...
    def _resolve_error_table(
        ...
        if isinstance(err, BadRequestError):
            if err.code == 415:
                return "E_B4_00070", ErrorCode.UNSUPPORTED_MEDIA_TYPE, {}
...
def azure_function_get_error_handler(
    func: Callable[[azure_func.HttpRequest], azure_func.HttpResponse],
